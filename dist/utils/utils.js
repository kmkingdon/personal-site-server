const parseDataToPrompt = (skills, data) => {
    ...
    if (skills && skills.length) {
        ...
        data.workExperience.forEach((exp) => {
            if (exp.tags.some((item) => skills.includes(item))) {
        ...
        data.education.forEach((edu) => {
            if (edu.tags.some((item) => skills.includes(item))) {
...
export const createAboutPrompt = (params) => {
